...
internal val metroLines: List<LineData> = listOf(
...
internal val stationPositions: Map<String, GeoPoint> = mapOf(
...
internal val stationLines: Map<String, List<String>> by lazy {
...
internal val stationPoints: Map<String, GeoPoint> by lazy {
